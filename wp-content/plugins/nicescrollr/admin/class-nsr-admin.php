...
class nsr_admin {
	...
	public function enqueue_styles() {
		...
		if(isset($this->settings['backend']['bt_enabled']) && $this->settings['backend']['bt_enabled']) {
			...
			wp_enqueue_style(
				'nicescrollr-backtop-css',
				plugin_dir_url(__FILE__) . '../assets/backtop.css',
				array(),
				'all'
			);
		}
	...
	public function enqueue_scripts() {
		...
		if(isset($this->settings[$this->view]['enabled']) && $this->settings[$this->view]['enabled']) {
			...
			wp_enqueue_script(
				...
				plugin_dir_url(__FILE__) . '../assets/nicescroll.js',
				array(
					'jquery',
		...
		if(isset($this->settings['backend']['bt_enabled']) && $this->settings['backend']['bt_enabled']) {
			...
			// Backtop
			wp_enqueue_script(
				'nicescrollr-backtop-js',
				plugin_dir_url(__FILE__) . '../assets/backtop.js',
				array(
					'jquery',
				),
				'all'
