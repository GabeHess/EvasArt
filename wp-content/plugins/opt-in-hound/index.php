...
Class Opt_In_Hound {
	...
	public function __construct() {
		...
		add_action( 'oih_update_check', array( $this, 'update_database_tables' ) );
	...
	public function include_files() {
		...
		// Deactivation Module
		if( file_exists( OIH_PLUGIN_DIR . 'includes/modules/deactivate/functions.php' ) )
			require OIH_PLUGIN_DIR . 'includes/modules/deactivate/functions.php';

		if( file_exists( OIH_PLUGIN_DIR . 'includes/modules/deactivate/class-submenu-page-uninstall.php' ) )
			require OIH_PLUGIN_DIR . 'includes/modules/deactivate/class-submenu-page-uninstall.php';
		...
		if( file_exists( OIH_PLUGIN_DIR . 'includes/modules/opt-in-active-period/functions.php' ) )
			require OIH_PLUGIN_DIR . 'includes/modules/opt-in-active-period/functions.php';
