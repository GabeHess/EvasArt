...
Class OIH_Display_Rule_Validator_Pages extends OIH_Display_Rule_Validator_Abstract implements OIH_Display_Rule_Validator_Interface {
	...
	public function is_displayable() {
		...
		$explicit_posts = ( ! empty( $this->_args['explicit'] ) && is_string( $this->_args['explicit'] ) ? array_map( 'trim', explode( ',', $this->_args['explicit'] ) ) : array() );
