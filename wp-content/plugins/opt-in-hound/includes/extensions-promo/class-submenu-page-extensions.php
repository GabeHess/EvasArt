...
function oih_add_submenu_page_extensions() {
	...
	new OIH_Submenu_Page_Extensions( 'opt-in-hound', __( 'Extensions', 'opt-in-hound' ), '<span style="color: orange;">' . __( 'Extensions', 'opt-in-hound' ) . '</span>', 'manage_options', 'oih-extensions' );
