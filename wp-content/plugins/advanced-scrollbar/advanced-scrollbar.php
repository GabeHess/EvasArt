...
/*-------------------------------------------------------------------------------*/	
add_action( 'admin_menu', 'csb_plg_menu_page' );
function csb_plg_menu_page() {
    add_menu_page(
        __( 'Custom color scrollbar', 'csb' ),
        'Custom color scrollbar',
        'manage_options',
        'options-general.php?page=c_s_b_setting',
        '',
        plugins_url( 'advanced-scrollbar/img/icn.png' ),
        6
    );
}
/*-------------------------------------------------------------------------------*/
